...
as well as the genes that are involved in determining cell polarity \emph{vang-1}, \emph{prkl-1} \cite{Wu2006, Hoffmann2010} are also amongst the selected 20\% of the highest scoring genes. 
