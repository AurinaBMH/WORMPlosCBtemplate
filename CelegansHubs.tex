...
The rich-club organization of hub connectivity is thought to play a central role in integrating functionally diverse and anatomically disparate neuronal systems \cite{Fornito:2015dq, VandenHeuvel2013a, ZamoraLopez:2010hy, Crossley2014, Crossley:2013kl}.
...
The connectome of this animal, which comprises 302 neurons and around 5600 chemical and electrical synapses \cite{White1986}, is the only species to have its connectome mapped almost completely at the level of individual neurons and synapses using electron microscopy \cite{White:1986tx, Varshney2011}.
...
The chemical synapse network is both directed (i.e., for each synapse, we can identify the pre-synaptic neuron and the post-synaptic target) and weighted (as determined by the number of synapses between pairs of neurons) while gap junctions are conventionally represented as an undirected connections.
...
(iii) a combination of chemical and electrical synapses as an undirected network (representing unidirectional and reciprocal chemical connections equivalently) \cite{Towlson:2013gf, Kim:2014bu, Pavlovic:2014gx};
...
The resulting connectome contains 279 neurons, with 2\,287 unique connected pairs of neurons and a total of 2\,990 individual edges.
% <<BasicStats.m>>
...
We also compared results to a previously-reported nine-module partition derived from an Erd\"os-R\'enyi Mixture Model (ERMM) \cite{Pavlovic2014}.
