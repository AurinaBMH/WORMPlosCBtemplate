...
Other top GO categories include memory ($p_\mathrm{uncorrected} = 0.005$), `ion transport' ($p_\mathrm{uncorrected} = 0.007$), and `nonassociative learning' ($p_\mathrm{uncorrected} = 0.01$).
...
Hub connectivity those driving an increase in connections involving hub neurons are enriched in oxidative energy metabolism (a result corroborated at a regional level in human \cite{Vertes2016a}).
