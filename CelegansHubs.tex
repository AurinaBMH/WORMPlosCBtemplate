...
The 92 bilateral pairs of neurons (e.g., AVAL/AVAR, CEPVL/CEPVR, etc.) mostly exhibit highly correlated gene expression patterns, with all bilateral pairs of neurons exhibiting $r_\phi > 0.8$, and 96\% exhibiting $r_\phi > 0.95$.
...
Our CGE measure, $r_\phi$, measures the association between the expression profiles of two neurons across all 948 genes.
