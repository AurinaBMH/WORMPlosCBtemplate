...
Connection probability also decreases with spatial separation between mammalian brain areas \cite{Henderson:2014fg, Horvat:2016ia, Wang:2016gg, Markov:2013jo, Fulcher:2016ck} and neurons \cite{Levy:2012dy}, and between \emph{C. elegans} neurons (cf. Fig.~S1 of \cite{Azulay:2016cg}).
...
Furthermore, gene coexpression is significantly increased amongst hub neurons relatively to other pairs of head neurons (Wilcoxon rank sum test, $p = 4.1 \times 10^{-11}$ for 46 hub-hub pairs and 1\,186 others),
