...
For this purpose, we separated neurons that are formed early (during the first 1000 min) in the development into two types, namely hubs and non-hubs, and compared coexpression within each of those groups \ref{BirthTimeHubs}. 
...
\begin{figure}[t]
 ...
 \caption{\textbf{Coexpression between early born hubs and early born non-hubs. } ($P < 10^{-28}$, Wilcoxon rank sum test)
}
