...
To explore these results in more detail, we manually investigated individual high-scoring genes submitted to ORA analysis [[TODO-AA: provide list as suppl with FDR p-valuese AA: these tables are very big (85 rows and 30 rows), I thought we would provide them as xls file?]].
