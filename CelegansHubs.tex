...
In this work we use a directed binary connectivity matrix of chemical synapses provided by \citep{Varshney2011} for 279 non-pharingeal neurons (nodes) and 1961 connections between them (edges) and show a rich-club organisation of the chemical synapse network (see \textit{Materials and Methods}).
...
\begin{figure}[!h]
   \centering
    \includegraphics[width=0.7\textwidth]{RCcurveFINAL3}
...
\begin{figure}[!h]
\centering
    \includegraphics[width=1\textwidth]{Extras}
