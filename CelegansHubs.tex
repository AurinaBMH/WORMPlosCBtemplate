...
Note that previous work has used different processed versions of this data, including a combination of synaptic connections and gap junctions together as here \cite{Azulay:2016cg, Kim:2016gl}, just synaptic connections (e.g., following thresholding \cite{Kashtan:2004ev}), or a combination of synaptic and gap junctions that are afterwards symmetrisized to represent unidirectional synaptic connections as bidirectional \cite{Towlson:2013gf, Kim:2014bu, Pavlovic:2014gx}. 
...
Because all \emph{C. elegans} hub neurons are born prior to hatching \cite{Varier2011, Towlson2013}, and neurons both at similar times may share connectivity and other properties \cite{Schroter:2017eo}, we investigated whether the increase in coexpression between hub neurons is influenced by similarity in their birth time.
...
[[TODO(AF->AA): should first characterize general relationship between lineage and coexpression, and then address hub effect]]
...
Hub neurons ($k > 44$) consist of 13 cholinergic neurons, 2 glutamatergic neurons, and 1 neuron of unknown type.
To determine whether the increase in coexpression amongst pairs of hub neurons could be explained by their neurotransmitter type, we used a permutation test to compute the mean coexpression between all pairs of random groups of 16 neurons of the same neurotransmitter types (e.g., 13 random cholinergic neurons, 2 random glutamatergic neurons, and 1 random neuron of unknown neurotransmitter type), using $1\times 10^6$ random permutations.
The mean coexpression between hub neurons was significantly increased relative to random sets $p = 3.8\times 10^-5$.
...
\paragraph*{S3 Table.}
{\bf Enrichment results for chemical \textit{vs} electrical links.}

\begin{table}[]
\centering
\caption{Biological processes GO categories showing increased gene coexpression for chemical links compared to electrical links.}
\label{enrichmentChemical}
\begin{tabular}{llll}
\hline
\textbf{GOcategory} & \textbf{Description}                                     & \textbf{No. of genes} & \textbf{P value}    \\ \hline
\underline{GO:1901617} & organic hydroxy compound biosynthetic process   & 7        & 1e-05   \\
\underline{GO:0018958} & phenol-containing compound metabolic process    & 5        & 4e-05   \\
\underline{GO:0046189} & phenol-containing compound biosynthetic process & 5        & 4e-05   \\
\underline{GO:1901615} & organic hydroxy compound metabolic process      & 8        & 6e-05   \\
\underline{GO:0006082} & organic acid metabolic process                  & 11       & 0.00013 \\
\underline{GO:0043436} & oxoacid metabolic process                       & 11       & 0.00013 \\
\underline{GO:0044249} & cellular biosynthetic process                   & 63       & 0.00028 \\
\underline{GO:0009058} & biosynthetic process                            & 64       & 0.00029 \\
\underline{GO:1901576} & organic substance biosynthetic process          & 64       & 0.00029 \\
\underline{GO:0044711} & single-organism biosynthetic process            & 27       & 0.0003  \\
\underline{GO:1901566} & organonitrogen compound biosynthetic process    & 24       & 0.00032 \\
\underline{GO:1901564} & organonitrogen compound metabolic process       & 28       & 0.00035 \\
\underline{GO:0006520} & cellular amino acid metabolic process           & 7        & 0.00064 \\
\underline{GO:0019752} & carboxylic acid metabolic process               & 10       & 0.00087 \\
\underline{GO:0008283} & cell proliferation                              & 6        & 0.0012  \\\hline
\end{tabular}
\end{table}
