...
For each degree threshold $\geq k$ we computed 1000 random networks rewiring each edge an average of 50 times per null net- work. 
Statistical significance for $\Phi_{norm}$ was estimated by computing P value directly from the empirical null
...
EFFECT OF SPACE - no clear relationship, therefore can't be corrected in a systematic manner.\\
Excluding L/R expression values.  
