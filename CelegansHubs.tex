...
No GO categories were statistically significant (FDR $< 0.05$); all categories are listed in Table~\ref{tab:enrichmentRICH}.
...
\begin{tabular}{llccc}
\hline
GO ID & Description & \# genes & $p_\mathrm{uncorr}$ & $p_\mathrm{corr}$\\\hline
