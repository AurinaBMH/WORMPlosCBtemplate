...
We demonstrate that this effect \color{teal} is not associated with the factors \color{black} such as neuronal birth time, lineage, neurotransmitter system or spatial position but may rather be related to the functional specialization of hub neurons in mediating higher order behaviours of the organism.
...
% This indicates that when nodes are defined as hubs (degree $>k$) in this range, they are more densely interconnected than expected by chance.
...
%Bottom: Median lineage distance for rich, feeder, and peripheral connections as a function of $k$, with the %median across all network links shown as a dashed black line and the topological rich club regime shaded grey.
...
%Top: Degree distribution. Bottom: Mean lineage distance for rich, feeder, and peripheral connections as a function %of $k$, with the median across all network links shown as a dashed black line and the topological rich club regime shaded grey.
