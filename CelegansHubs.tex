...
Investigations of mesoscale network organization in the mouse and macroscale organization in the human have identified a distinctive genomic signature of neural hubs, characterised by tightly coupled expression of genes regulative oxidative metabolism. 
Here, we sought to determine whether hubs of the C elegans connectome, which have been mapped at the microscale of individual neurons and synapses, show a similarly distinct genomic signature.
...
Our results suggest that neural hubs posses a distinct genomic signature that is preserved across scales and species, and that this signature is related to the involvement of hubs in regulating higher-order behaviours of the organism. 
