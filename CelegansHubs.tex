...
While hubs of the mouse connectome are broadly distributed across anatomical divisions, the 13 hub neurons in \emph{C. elegans} ($k > 41$) are all interneurons, all born early in development \cite{Varier2011}, are mostly cholinergic (11/13) \cite{Pereira:2015er}, and are mostly in a single network module.
