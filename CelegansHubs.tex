...
\centering
    ...
    \caption{
\textbf{Correlated gene expression for different types of connectome edges.}
\emph{Left}: Distribution of CGE between reciprocally connected (219 pairs), unidirectionally connected (1\,721) and  and unconnected (36\,749 pairs) pairs of neurons as a violin plot, with the median of each distribution shown as a horizontal line.
