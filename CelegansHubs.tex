...
Other categories are involved in the regulation of growth rate and several catabolic processes (see Table~\ref{enrichmentCON}).
...
No GO categories were statistically significant (FDR $< 0.05$); all categories are listed in Table~\ref{enrichmentRICH}.
...
The implication of glutamate receptor signaling for synaptic connectivity, and hub connectivity in particular, is somewhat surprising, as only 26\% of neurons with known neurotransmitter type are glutamatergic (whereas 55\% are cholinergic) and just 2 of the 16 hubs are glutamatergic; 13 are cholinergic, and one is of unknown type.
Furthermore, just 32\% of neurons that project to hubs are glutamatergic.
% FeedInOutNodes;
Our inability to get a comprehensive understanding of neurotransmitter signalling for the gene expression data used here is related to the incompleteness of the data.
For example, only one acetylcholine-related GO category---`synaptic transmission, cholinergic' (GO:0007271)---contained enough genes (14 genes) to be represented in our enrichment analysis.
...
Glutamate release categories were also not represented here (each were annotated with fewer than 5 genes in our dataset and hence excluded).
More comprehensive expression data could use the methods developed here to obtain greater understanding of the relationship between network topology, neurotransmitter signalling, and other gene-regulated functions.
