...
[[TODO: Aurina, can you check this? Alex added: ``As first demonstrated by Towlson et al. \cite{Towlson:2013gf}'']], hubs are born early in the \textit{C. elegans} development \cite{Varier2011} (see Fig \ref{fig:BirthTimesk}), therefore we next verified that the increase in coexpression between them can not be explained by the similarity in birth time. 
