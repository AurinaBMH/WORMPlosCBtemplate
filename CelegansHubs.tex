...
Lineage data was downloaded from WormAtlas (\url{http://www.wormatlas.org/neuronalwiring.html#Lineageanalysis}).
In this dataset for each pair of neurons a common ancestor cell was identified using embryonic and  post-embryonic lineage trees \citep{Sulston1977, Sulston1983} and a total number of cell divisions from the common progenitor was calculated.  
For the analysis data were arranged into a matrix format where lineage distance for each pair of neurons was defined. % part of Print_neuroconnect.m 
