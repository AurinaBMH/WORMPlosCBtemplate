...
Here we plot the mean correlation between the two vectors, averaged over 1\,000 runs, for 946-long vectors with between 0--0.16 proportion of ones [[TODO: how many voxels?]].
...
% <<CoExpressionDistanceDetail(C,G)>>
% ------------------------------------------------------------------------------
\begin{figure}[h]
\centering
...
[[TODO: make this look decent -- could stretch and then put all bars into a single plot, rather than A--C. NOTE: representation on top of bars looks misleading for peripheral, maybe make both blue and add arrows?Labels not visible for B]]
}
\end{figure}
% ------------------------------------------------------------------------------
