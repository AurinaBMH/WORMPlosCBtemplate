...
\color{teal}
Finally, studies of gene expression often assume that expression levels correspond to protein abundance, an assumption that does not always hold \cite{Futcher1999, Greenbaum2003, Gygi1999}. 
Thus, analyses of the transcriptomic data can be viewed as a relatively efficient approach for investigating potential links between molecular function and nervous system organization, that may be more strongly verified with subsequent proteomic analysis.
\color{black}
