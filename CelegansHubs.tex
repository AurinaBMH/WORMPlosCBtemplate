...
In contrast, other measures such as Jaccard index, Yule's Q, Yule's Y are highly dependent on this ratio.
...
To distinguish matching of positive gene expression from negative gene expression, we also developed a new index that quantifies that probability that two binary strings will contain at least as many positive matches as observed (see Supplementary Information), which gave similar results
[[TODO: check that behavior is similar]].
