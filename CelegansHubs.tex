...
Even among early born neurons, connections between hubs (rich) show significantly increased coexpression compared to all other connections (non-rich: feedin, feedput, peripheral) (add p value, ranksum value). 
