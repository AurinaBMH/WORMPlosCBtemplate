...
In order to take into account the influence of both synaptic and gap junction connectivity, our analysis is mainly focused on the combined directed, unweighted network that includes both types of connections, representing gap junction connections as bidirectional.
This network of 279 neurons consists of 2\,287 connected pairs of neurons, spanning a total of 2\,990 directed connections (and the weighted network includes a total of 8\,168 individual synapses).
