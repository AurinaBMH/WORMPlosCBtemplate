...
We arrived at the following set of anatomically similar nonhub interneurons: AVFL, AVFR, AVHL, AVHR, AVKL, AVKR, AVJL, and AVJR.
...
It has been shown that neurons born at similar times may share similar properties including connectivity \cite{Schroter:2017eo}, therefore, we investigated whether the increase in coexpression between hub neurons is influenced by similarity in their birth time.
