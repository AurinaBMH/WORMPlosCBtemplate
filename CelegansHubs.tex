...
We see that the Pearson correlation (Fig.~\ref{fig:S_propOnes}A)
The Pearson binary correlation, mean square contingency coefficient, $r_\phi$, best met this criterion.
...
\caption{
[[TODO: Add A, B, C labels, and add our new positive match measure.]]
}
\end{figure}
