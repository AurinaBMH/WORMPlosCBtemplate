...
Compared to continuous expression measurements of over 17\,000 genes in the mouse brain \cite{Lein:2007jn}, which includes permits more subtle analysis \cite{Fulcher:2016ck, Ji:2014jw, Fakhry:2015kl, French2011}, the key challenge of working with these expression data are its minimal coverage of the full worm genome (contains $>20\,000$ genes), binary expression indicators, and inability to distinguish missing data from lack of expression.
