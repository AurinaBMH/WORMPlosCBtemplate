...
Given these genes are implicated in neuronal connectivity in other species \cite{Paemka2013, Ehaideb2016, Sowers2013}, we confirm that our method can potentially produce preliminary predictions for the genetic signature in \textit{C. elegans} nervous system. 
...
Both adhesion molecules as well as transcription factors and potentially involved in facilitating signal transduction and communication.
Despite incomplete and noisy data, our results indicate that our data-driven gene scoring method is able to yield sensible, biologically relevant insights. 
