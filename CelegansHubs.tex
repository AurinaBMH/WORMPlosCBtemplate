...
We find increased coexpression between neuron pairs connected via gap junctions compared to neurons connected via synapses (Wilcoxon rank-sum test, $P < 10^{-22}$).
