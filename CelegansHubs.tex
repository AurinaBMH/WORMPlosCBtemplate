...
These results show (i) increased coexpression in connected pairs of nodes;
(ii) the highest coexpression in rich connections; and
(iii) lowest coexpression in peripheral connections.
Obtained using incomplete binary annotations of gene expression across just 948 genes in a microscale neuronal connectome, thay are consistent with a prior analysis of the expression of over 17\,000 genes across 213 regions of the mesoscale mouse connectome.
