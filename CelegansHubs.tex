...
Consequently, we characterized individual genes with 20\% of the high scores in each analysis, and attempted to summarize functional groups of genes as biological process categories of the gene ontology (GO) that were enriched in high scoring genes using overrepresentation analysis (ORA) \cite{Ashburner2000, Gillis2010}.
Gene sets submitted for ORA are comprised of 85 (out of 414) genes in the case of connected pairs of neurons compared to unconnected pairs and 30 (out of 168) genes for the analysis of links involving hubs.  
...
To explore these results in more detail, we manually investigated individual high-scoring genes submitted to ORA analysis [[provide list as suppl with FDR p-values]].
Given that glutamate is one of the most popular neurotransmitters in the \textit{C. elegans} nervous system (26\% of neurons with known neurotransmitter type are glutamatergic \cite{Pereira:2015er}[[THAT's our result from Pereira data]]), and many high scoring genes are related to glutamate receptors (\emph{glr-1}, \emph{glr-2}, \emph{glr-4}, \emph{glr-5}, \emph{nmr-1}, \emph{nmr-2}).
Consistent with the importance of innexins in forming electrical synapses, the following innexin genes were all in the top 20\%: \emph{unc-9}, \emph{unc-7}, \emph{inx-7}, \emph{inx-19}, \emph{inx-13} \cite{Starich2001}.
...
also were highly implicated in neuronal connectivity.
...
Therefore, despite incomplete and noisy data, our results indicate that our data-driven gene scoring method is able to yield biologically interpretable genes.\\
...
Here we show that both glutamate receptor signalling as well as more general receptor signaling class is implicated in hub connectivity.
