...
Finally, we find an increase in mean hub-hub connection distance with the degree threshold, $k$, with a significant increase through the topological rich-club regime ($P < 0.05$ [[TODO: what test? Is it $t$-test??]]Permutation test???), as shown in Fig.~\ref{fig:topology_rich}B.
