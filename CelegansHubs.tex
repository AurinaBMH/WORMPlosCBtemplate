...
\paragraph{Degree}
The total number of connections involving a given neuron is defined by its degree, $k$, defined as the sum of the number of incoming connections (in-degree, $k_\mathrm{in}$) and outgoing connections ($k_\mathrm{out}$), as $k = k_\mathrm{in} + k_\mathrm{out}$.
