...
Having characterized a robust relationship between hub connectivity and gene coexpression, we next investigate whether specific functional groups of genes are involved in the observed differences in gene coexpression.
We developed a method to score genes according to their contribution to a given coexpression pattern (see \emph{Methods}). 
These scores were used to perform an overrepresentation enrichment analysis using gene ontology (GO) categories for biological processes \cite{Ashburner2000, Gillis2010}.
...
Previous results using quantitative gene expression in mouse has indicated that genes driving an increase in coexpression between connected pairs of brain regions are enriched in GO categories related to neuronal connectivity and communication \cite{Fulcher:2016ck, Ji:2014jw, Fakhry:2015kl, French:2011cz}.
Relative to the above mentioned work in mouse, the current data are more challenging due to incomplete binary expression measurements in a small proportion of the genome, however we still expected to find some similar results. 
In line with our expectations, the top GO categories are related to glutamate receptor signaling, cell surface receptor signaling and ion transport. 
Other categories are involved in the regulation of growth rate and several catabolic processes, however none are significant at a false discovery rate of 0.05 (see Table~\ref{tab:enrichmentCON}).
Although the current gene expression data does not provide us with sufficient power to detect significant effects, top GO categories support the idea that similar functional gene groups are involved in neuronal connectivity in different species. 
In addition, it shows that our data driven method for scoring genes is reliable and with advancing data quality can be further used to investigate biological basis of neuronal organisation. \\
In order to explore these results in more detail we investigated individual genes used for the overrepresentation enrichment analysis, i.e. genes that contributed towards the increased coexpression the most.
Several biologically relevant gene groups including glutamate receptor genes (glr-1, glr-2, glr-4, glr-5, nmr-1, nmr-2), innexins (unc-9, unc-7, inx-7, inx-19, inx-13), cell adhesion molecules and transcription factors were found.

Given that glutamate is one of the most popular neurotransmitters in \textit{C. elegans} nervous system (26\% of neurons with known neurotransmitter type are glutamatergic) and the importance of innexins in forming the electrical synapses the involvement of both neurotransmiter as well as electrical synapse related genes is expected.

We also show that adhesion molecule genes related to axon outgrowth and guidance (sax-3, cam-1), cell migration (cam-1, unc-6, rig-1, unc-5 ), locomotion (cam-1, unc-5 ), learning (casy-1) \cite{Zallen1999, Garriga1999, Leung-Hagesteijn1992, Harris:2009kd, Ikeda2008} as well as two orthologs of Drosdophila genes involved in determining cell polarity (vang-1, prkl-1 \cite{Wu2006,Hoffmann2010}) are implicated. 

In addition, transcription factors regulating neuronal development, fate specification \cite{Sarafi-Reinach2001,Prasad2008,Baran1999,Cassata2000,Schmid2006,Shaham2002a} (lin-11 , unc-3, unc-42, ceh-14, ast-1, cfi-1) and locomotion \cite{Prasad2008} (unc-3) also play an important role in the increased coexpression between connected neurons. 
...
Top GO categories are listed in Table~\ref{tab:enrichmentRICH}. 
The same two glutamate receptor signaling categories implicated for connectivity above, were again at the top of the list of categories related to hub connectivity.
Other top categories include a more general receptor signalling class, regulation of locomotion, and various metabolism and biosynthesis related processes, although none are statistically significant at a false discovery rate of 0.05.\\
...
In addition to glutamate receptor (glr-5, nmr-1, nmr-2, glr-1, glr-2, grld-1) and acetylcholine related genes (ace-2, cho-1, unc-17, deg-3), we again find a high number of adhesion molecules (cam-1, rig-1, rig-6, unc-6, grld-1, dbl-1, ncam-1) and transcription factors (unc-3, unc-42, ast-1, pdfr-1) that at least partially overlap with genes found comparing connected and unconnected pairs of neurons.  
The implication of those two neurotransmitters can be explained given the importance of glutamate  in the regulation of locomotion in command interneurons \cite{Choi2015, Zheng1999} as well as acetylcholine being the dominant neurotransmitter in hubs (13 out of 16 hubs are cholinergic). 
High overlap between adhesion molecule and transcription factor genes found in the previous analysis and the implication of human orthologs (rig-1, ncam-1, grld-1) \cite{Harris:2009kd} for genes regulating cell migration, differentiation and neuron cell adhesion, shows the importance of establishing neuronal connections in both cases.  \\
...
\textbf{SUMMARY}
Here we for the first time investigate the relationship between correlated genes expression and neuronal connectivity in \textit{C. elegans}. 
We demonstrate the relationship between neuronal connectivity and patterns of genes expression in a data driven way and show that connections between hub neurons exhibit high transcriptional similarity which is driven by glutamate, acetylcholine and neuronal communication related genes.
Given the binary nature of the gene expression data, we developed a new method to evaluate the contribution of each gene towards the increase coexpression. 
With advancing data quality those methods could be implemented to investigate biological basis of different neuronal connectivity patters. 
...
We were able to reject influences of all except one potential driving factor 
The only potential driver of the effect ...
...
\textbf{GENES}
\begin{itemize}
     \item We developed methods to relate binary gene expression data to connectivity and afterwards to evaluate the effects of single genes by scoring them according to their influence.
With increasing quality of the gene expression data those methods will allow to comprehensively investigate relationships between these two modalities. 
     \item Although gene expression data is incomplete and gene enrichment analyses did not have enough power to detect significant effects, top GO categories point us into the right direction given biologically relevant categories emerge at the top.
     ...
     These results both provide the proof of concept in the methods we used for gene scoring as well as valuable information regarding the mechanisms involved in hub connectivity on a global level.
     \item Discuss specific groups of genes in case of connected and RF analyses - overlap, differences.
     \item 
\end{itemize}
