...
Positions for 3 neurons not included in this dataset (AIBL, AIYL, SMDVL) were reconstructed based on the positions of the contralateral neurons (AIBR, AIYR, SMDVR) by assigning identical coordinates for the contralateral neurons in these three pairs [[TODO: according to Varier 2011 \cite{Varier2011}.]].
...
Our index, $r_\xi$, computes the probability of fewer than this many matches as $r_\xi = \sum_{x=0}^{m-1} P(x)$.
...
\paragraph*{SX Fig.}
{\bf Connection probability and coexpression as a function of distance}

\begin{figure}[!h]
\label{S4_Fig}
\centering
    \includegraphics[width=1\textwidth]{distanceDependence.eps}
    \caption{Connection probability and coexpression as a function of distance}
\end{figure}
